...
def find_plates(path):
    ...
    import json
    from car_recognition.car_plate_recognition.openalpr.src.bindings.python.build.lib.openalpr.openalpr import Alpr
    print(os.path.dirname(__file__) + "/openalpr/runtime_data")
    alpr = Alpr("eu",
